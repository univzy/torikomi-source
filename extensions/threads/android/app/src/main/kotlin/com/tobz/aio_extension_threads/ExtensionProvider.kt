package com.tobz.aio_extension_threads
...
class ExtensionProvider : ContentProvider() {
    companion object { private const val SCRAPER_CHANNEL = "aio.extension.threads/scraper"; private const val TIMEOUT = 60L }
    override fun onCreate(): Boolean = true
    override fun query(uri: Uri, p: Array<String>?, s: String?, sa: Array<String>?, so: String?): Cursor {
        val url = uri.getQueryParameter("url") ?: ""; val latch = CountDownLatch(1); var json = ""
        ...
        MethodChannel(engine.dartExecutor.binaryMessenger, SCRAPER_CHANNEL).invokeMethod("scrape", mapOf("url" to url), object : MethodChannel.Result {

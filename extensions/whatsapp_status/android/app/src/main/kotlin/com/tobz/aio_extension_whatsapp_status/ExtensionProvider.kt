...
class ExtensionProvider : ContentProvider() {
    ...
    companion object {
        private const val SCRAPER_CHANNEL = "aio.extension.whatsapp_status/scraper"
    }
    ...
    override fun query(
        ...
        // url parameter is ignored — the scraper scans local storage directly
        ...
        ctx.mainLooper.let { looper ->
            android.os.Handler(looper).post {
                ...
                MethodChannel(engine.dartExecutor.binaryMessenger, SCRAPER_CHANNEL)
                    .invokeMethod("scrape", mapOf("url" to url, "cfCookies" to ""),
